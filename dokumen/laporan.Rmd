---
title: "Analisis Pengaruh Kemiskinan dan Rata Lama Sekolah Terhadap Pembangunan Wilayah di Indonesia"
output:
  pdf_document:
...
1.  Aulia Rezki Rahman - J0403251009
2.  Ibra Arifa Istara - J0403251029
3.  Muhammad Raihan Ramadhan - J0403251038
4.  Ihsan Hamizan - J0403251051
5.  Ivan Farel Aditya - J0403251087
6.  Raffan Fatih Zulfan - J0403251091
...
Dilihat dari ukuran penyebaran data, variabel pdrb_perkapita juga memiliki standar deviasi terbesar, yaitu sekitar 89.341.270, dengan varians sebesar 7,98 × 10^15^. Nilai tersebut menunjukkan bahwa data PDRB per kapita memiliki variasi yang sangat besar antar wilayah yang diamati.
...
Berdasarkan hasil pengolahan data akhir setelah melalui tahapan preprocessing, termasuk imputasi missing value dengan nilai median dan filtrasi data ekstrem menggunakan metode Interquartile Range, diperoleh parameter distribusi baru untuk variabel tingkat kemiskinan. Ruang sampel data kini dibatasi secara tegas oleh pagar pengaman dengan batas minimum sebesar 2,01% dan batas maksimum sebesar 25,00%. Dari dataset yang telah steril ini, didapatkan nilai rata-rata sebesar 13,64% dengan standar deviasi sebesar 6.61%. Nilai standar deviasi yang relatif terkendali ini menunjukkan jarak sebaran data yang stabil di sekitar nilai pusatnya, yang menjadi fondasi penting dalam pembentukan kurva distribusi peluang kontinu.

![](images/Perbandingan%20Distribusi%20Peluang%20Kemiskinan-01.png)

Analisis visual terhadap Fungsi Kepadatan Probabilitas menunjukkan adanya dinamika unik antara Kurva Densitas Empiris atau data riil lapangan bertanda garis merah dengan Kurva Normal Teoritis Gauss yang bertanda garis biru putus-putus. Model teoretis Distribusi Normal memprediksi bahwa massa peluang terbesar akan memuncak tajam secara simetris di sekitar nilai rata-rata 13,64%. Namun, data riil di lapangan menunjukkan karakteristik yang berbeda, di mana puncak kurva cenderung landai dan membentuk dataran bergelombang yang merata pada rentang tingkat kemiskinan 5% hingga 22%. Pada area ini, indeks kerapatan data atau density stabil berada di sekitar angka 0,04. Hal ini mengandung makna probabilitas bahwa setiap terjadi kenaikan rentang sebesar 1% pada angka kemiskinan, jumlah wilayah yang menempatinya selalu konsisten menyumbang proporsi sekitar 4% dari total keseluruhan wilayah sampel. Fenomena homogenitas ini menyebabkan kedua kurva saling memotong silang; kurva teoretis menilai terlalu tinggi peluang di titik tengah, namun menilai terlalu rendah (underestimate) potensi kemunculan wilayah pada klaster kemiskinan rendah sekitar 5% dan klaster kemiskinan tinggi sekitar 20%.

Untuk memvalidasi asumsi normalitas secara lebih spesifik, dilakukan pengujian visual melalui Quantile-Quantile Plot. Grafik ini mengadu antara posisi urutan data riil lapangan pada sumbu Y terhadap urutan data ekspektasi teori matematika pada sumbu X. Hasil plot memperlihatkan pola sebaran data yang membentuk kurva S. Pada bagian massa data utama di area pusat distribusi dengan rentang Z-score -1 hingga 1, seluruh kumpulan titik sampel berhimpit secara linear dan menindih garis referensi merah diagonal dengan sangat rapi. Hal ini menjadi bukti konkret bahwa karakteristik data pada klaster menengah sudah memenuhi asumsi Distribusi Normal secara valid.

![](images/Ujinormalisasi.png)
...
Adapun deviasi berupa kelengkungan mendatar yang membelot dari garis merah pada ujung kiri bawah dan ujung kanan atas kurva bukanlah sebuah cacat data, melainkan representasi visual dari efek pemotongan ekor distribusi. Pola mendatar ini terjadi karena data sampel asli pada sumbu Y dipaksa berhenti akibat menabrak tembok batas fisik hasil filter outlier, yaitu pada angka 2,01% di ujung bawah (area Z-score negatif yang merepresentasikan wilayah-wilayah di bawah rata-rata atau lebih sejahtera) dan angka 25,00% di ujung atas (area Z-score positif yang merepresentasikan wilayah di atas rata-rata).

Secara keseluruhan, meskipun terdapat pemangkasan mekanis di kedua ujung ekor kurva demi menjaga akurasi pemodelan, sebaran data kemiskinan ini dinilai sangat sehat, memiliki pola yang konsisten, dan sangat akurat untuk digunakan dalam perhitungan prediksi peluang kontinu menggunakan fungsi parametrik seperti pnorm maupun qnorm
...
Purnama YC. 2026. kenapa p-value Harus Dibawah 0.05?. 12(52):1-3.
